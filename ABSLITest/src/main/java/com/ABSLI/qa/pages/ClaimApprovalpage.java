...
public class ClaimApprovalpage extends AbsliParent {
	...
	public void Approvalmethod() throws AWTException, InterruptedException {
		/*
		 * Robot robot = new Robot(); Thread.sleep(8000); ClaimsDrop.click();
		 * Thread.sleep(3000); Approval.click(); Thread.sleep(3000);
		 * Clientname.sendKeys("cynnent"); Thread.sleep(3000);
		 * Clientname.sendKeys(Keys.ARROW_DOWN, Keys.ENTER); Thread.sleep(3000);
		 * MasterPolicyNumber.click(); Thread.sleep(5000);
