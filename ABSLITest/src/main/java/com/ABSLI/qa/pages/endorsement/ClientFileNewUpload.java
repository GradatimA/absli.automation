...
public class ClientFileNewUpload extends AbsliParent {

	@FindBy(xpath = "//input[@id='ContentPlaceHolder1_txtSearchGroupName']")
	WebElement ClientName;
	
	@FindBy(xpath = "//span[@id='select2-ContentPlaceHolder1_ddlSearchMasterPolicyNumber-container']")
	WebElement masterPolicynum;
	
	@FindBy(xpath = "//span[@id='select2-ContentPlaceHolder1_ddlSearchAgreementNumber-container']")
	...
	public ClientFileNewUpload() {
		PageFactory.initElements(driver, this);
	}
	
	public void clientuploadprocess(String clinam,String masternum,String Agreenum,String path) throws Throwable {
