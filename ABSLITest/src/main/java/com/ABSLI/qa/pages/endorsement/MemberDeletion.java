...
public class MemberDeletion extends AbsliParent {
	...
	public MemberDeletion() {
		PageFactory.initElements(driver, this);
	}
	public void deletionprocess(String clinam,String masternum,String Agreenum,String path) throws Throwable {
