...
public class MemberDeletionReversal extends AbsliParent {
	...
	public MemberDeletionReversal() {
		PageFactory.initElements(driver, this);
	}

	public void mdreversalprocess(String clinam, String masternum, String Agreenum, String path) throws Throwable 
	{
