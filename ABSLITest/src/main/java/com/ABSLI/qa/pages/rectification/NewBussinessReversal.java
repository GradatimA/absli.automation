...
public class NewBussinessReversal extends AbsliParent {
	...
	public NewBussinessReversal() {
		PageFactory.initElements(driver, this);
	}

	public void nbreversalprocess(String clinam, String masternum, String Agreenum, String path) throws Throwable {
