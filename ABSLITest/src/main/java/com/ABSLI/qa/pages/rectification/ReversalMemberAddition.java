...
public class ReversalMemberAddition extends AbsliParent
{
	...
	public ReversalMemberAddition() {
		PageFactory.initElements(driver, this);
	}

	public void mareversalprocess(String clinam, String masternum, String Agreenum, String path) throws Throwable {
