...
public class SumAssuredReversal extends AbsliParent {
	...
	public SumAssuredReversal() {
		PageFactory.initElements(driver, this);
	}

	public void sareversalprocess(String clinam, String masternum, String Agreenum, String path) throws Throwable {
