...
public class NischintMemberUpload extends AbsliParent {
    ...
    public NischintMemberUpload() {
    	PageFactory.initElements(driver, this);
    }
    
    public void memberprocess(String clinam,String masternum,String Agreenum,String author,String path) throws Throwable {
