package com.ABSLI.qa.pages.renewal;
...
public class RenewalMemberUpload extends AbsliParent {

	@FindBy(xpath = "//input[@id='ContentPlaceHolder1_txtGroupName']")
	...
	WebElement AuthorisedSignatory;
	
	
	
	public RenewalMemberUpload() {
		PageFactory.initElements(driver, this);
	}
	public void renewalmemberprocess(String clinam,String masternum,String Agreenum,String author,String path) throws Throwable {
	...
	wait.until(ExpectedConditions.elementToBeClickable(AuthorisedSignatory));
	AuthorisedSignatory.click();
	Thread.sleep(3000);
	inputBox.sendKeys(author,Keys.ENTER);
	Thread.sleep(3000);
