...
public class TC_MPM_018_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRC extends AbsliBase {
	...
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_018.xlsx", "TC_MPM_018");
		return arrobj;			
	}
	...
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRC(String clientName, 
			...
			String benefits4, String varientType4, String freeCoverLimitValue) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRC(clientName, agreementNumberValue, 
				...
				minimumCapValueForAdditionalRider, maximumCapValueForAdditionalRider, benefits4, varientType4, freeCoverLimitValue);
	}
