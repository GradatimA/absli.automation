...
public class TC_MPM_019_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRR extends AbsliBase {
	...
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_019.xlsx", "TC_MPM_019");
		return arrobj;			
	}
	...
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRR(String clientName, 
			...
			String benefits4, String varientType4, String percentageofofBaseBenefitValue4, String freeCoverLimitValue4, String minimumCapValue4, String maximumCapValue4) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsCRRR(clientName, agreementNumberValue, 
				...
				percentageofofBaseBenefitValue4, freeCoverLimitValue4, minimumCapValue4, maximumCapValue4);
	}
