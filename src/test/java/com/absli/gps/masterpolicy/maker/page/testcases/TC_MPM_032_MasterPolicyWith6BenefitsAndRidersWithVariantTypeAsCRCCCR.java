...
public class TC_MPM_032_MasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCCR extends AbsliBase {
	...
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_032.xlsx", "TC_MPM_032");
		return arrobj;			
	}
	...
	public void createAMasterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCCR (String clientName, 
			...
			String benefits6, String varientType6, String percentageofBaseBenefitValue6, String freeCoverLimitValue6, String minimumCapValue6, String maximumCapValue6) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith6BenefitsAndRidersWithVariantTypeAsCRCCCR(clientName, agreementNumberValue, 
				...
				varientType5, freeCoverLimitValue5, benefits6, varientType6, percentageofBaseBenefitValue6, freeCoverLimitValue6, 
				minimumCapValue6, maximumCapValue6);
	}
