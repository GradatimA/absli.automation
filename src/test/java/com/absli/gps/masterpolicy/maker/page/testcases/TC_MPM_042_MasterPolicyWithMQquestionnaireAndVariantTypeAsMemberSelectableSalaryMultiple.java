...
public class TC_MPM_042_MasterPolicyWithMQquestionnaireAndVariantTypeAsMemberSelectableSalaryMultiple extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_042")
	public Object[][] getTestDataFromTestDataFromTC_MPM_042()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_042.xlsx", "TC_MPM_042");
		return arrobj;			
	}
	
	@Test(priority = 41,dataProvider = "TestDataFromTC_MPM_042", dataProviderClass = TC_MPM_042_MasterPolicyWithMQquestionnaireAndVariantTypeAsMemberSelectableSalaryMultiple.class)
	public void createAMasterPolicyWithMQquestionnaireAndVariantTypeAsMemberSelectableSalaryMultiple (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String unitAddress, String addressDetails, String benefits, String varientType, String multiplesOfSalaryCountValue, String freeCoverLimitValue, 
			String minimumCapValue, String maximumCapValue) throws Throwable
	{
		homePage.masterPolicyMakerPage();
		masterPolicyMakerPage= new MasterPolicyMakerPage();
		masterPolicyMakerPage.masterPolicyWithMQquestionnaireAndVariantTypeAsMemberSelectableSalaryMultiple(clientName, 
				...
				multiplesOfSalaryCountValue, freeCoverLimitValue, minimumCapValue, maximumCapValue);
	}
