...
public class TC_MPM_043_MasterPolicyWithMQquestionnaireAndVariantTypeAsVariableTypeSumAssured  extends AbsliBase{
	...
	@Test(priority = 42,dataProvider = "TestDataFromTC_MPM_043", dataProviderClass = TC_MPM_043_MasterPolicyWithMQquestionnaireAndVariantTypeAsVariableTypeSumAssured.class)
	public void createAMasterPolicyWithMQquestionnaireAndVariantTypeAsVariableTypeSumAssured (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String minimumCapValue, String maximumCapValue) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWithMQquestionnaireAndVariantTypeAsVariableTypeSumAssured(clientName, 
