...
public class TC_MPM_044_MasterPolicyWithMQquestionnaireAndVariantTypeAsVoluntaryCustomerDefinedSA extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_044")
	public Object[][] getTestDataFromTestDataFromTC_MPM_044()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_044.xlsx", "TC_MPM_044");
		return arrobj;			
	}
	
	@Test(priority = 43,dataProvider = "TestDataFromTC_MPM_044", dataProviderClass = TC_MPM_044_MasterPolicyWithMQquestionnaireAndVariantTypeAsVoluntaryCustomerDefinedSA.class)
	public void createAMasterPolicyWithMQquestionnaireAndVariantTypeAsVoluntaryCustomerDefinedSA (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String minimumCapValue, String maximumCapValue) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWithMQquestionnaireAndVariantTypeAsVoluntaryCustomerDefinedSA(clientName, 
