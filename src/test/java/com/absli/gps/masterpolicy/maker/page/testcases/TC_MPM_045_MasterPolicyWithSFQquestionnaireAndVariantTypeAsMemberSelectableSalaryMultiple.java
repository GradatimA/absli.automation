...
public class TC_MPM_045_MasterPolicyWithSFQquestionnaireAndVariantTypeAsMemberSelectableSalaryMultiple extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_045")
	public Object[][] getTestDataFromTestDataFromTC_MPM_045()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_045.xlsx", "TC_MPM_045");
		return arrobj;			
	}
	
	@Test(priority = 44,dataProvider = "TestDataFromTC_MPM_045", dataProviderClass = TC_MPM_045_MasterPolicyWithSFQquestionnaireAndVariantTypeAsMemberSelectableSalaryMultiple.class)
	public void createAMasterPolicyWithSFQquestionnaireAndVariantTypeAsMemberSelectableSalaryMultiple (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String minimumCapValue, String maximumCapValue) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWithSFQquestionnaireAndVariantTypeAsMemberSelectableSalaryMultiple(clientName, 
