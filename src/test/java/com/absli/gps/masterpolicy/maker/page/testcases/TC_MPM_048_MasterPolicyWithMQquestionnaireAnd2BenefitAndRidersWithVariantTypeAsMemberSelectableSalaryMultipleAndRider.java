...
public class TC_MPM_048_MasterPolicyWithMQquestionnaireAnd2BenefitAndRidersWithVariantTypeAsMemberSelectableSalaryMultipleAndRider  extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_048")
	public Object[][] getTestDataFromTestDataFromTC_MPM_048()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_048.xlsx", "TC_MPM_048");
		return arrobj;			
	}
	
	@Test(priority = 47,dataProvider = "TestDataFromTC_MPM_048", dataProviderClass = TC_MPM_048_MasterPolicyWithMQquestionnaireAnd2BenefitAndRidersWithVariantTypeAsMemberSelectableSalaryMultipleAndRider.class)
	public void createAMasterPolicyWithMQquestionnaireAnd2BenefitAndRidersWithVariantTypeAsMemberSelectableSalaryMultipleAndRider (String clientName, String agreementNumberStringValue, String quotationDetailsStringValue, 
			...
			String benefits2, String varientType2, String percentageofBaseBenefitValueForInbuildRider, String freeCoverLimitValueForInbuildRider, String minimumCapValueForInbuildRider, String maximumCapValueForInbuildRider) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWithMQquestionnaireAnd2BenefitAndRidersWithVariantTypeAsMemberSelectableSalaryMultipleAndRider(
				...
				multiplesOfSalaryCountValueForBaseBenefit, freeCoverLimitValueForBaseBenefit, 
				minimumCapValueForBaseBenefit, maximumCapValueForBaseBenefit, benefits2, 
