...
public class TC_MPM_051_MasterPolicyWithSFQquestionnaireAnd2BenefitAndRidersWithVariantTypeAsMemberSelectableSalaryMultipleAndRider extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_051")
	public Object[][] getTestDataFromTestDataFromTC_MPM_051()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_051.xlsx", "TC_MPM_051");
		return arrobj;			
	}
	
	@Test(priority = 50,dataProvider = "TestDataFromTC_MPM_051", dataProviderClass = TC_MPM_051_MasterPolicyWithSFQquestionnaireAnd2BenefitAndRidersWithVariantTypeAsMemberSelectableSalaryMultipleAndRider.class)
	public void createAMasterPolicyWithSFQquestionnaireAnd2BenefitAndRidersWithVariantTypeAsMemberSelectableSalaryMultipleAndRider 
			...
			String benefits2, String varientType2, String percentageofBaseBenefitValueForInbuildRider, String freeCoverLimitValueForInbuildRider, String minimumCapValueForInbuildRider, String maximumCapValueForInbuildRider) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWithSFQquestionnaireAnd2BenefitAndRidersWithVariantTypeAsMemberSelectableSalaryMultipleAndRider(clientName, 
				agreementNumberStringValue, quotationDetailsStringValue, title, firstName, number, emailIDStringValue, numberOfInsured, 
				totalSumAssuredStringValue, inceptionDateValue, agentCodeValue, brokerageUpdationValue, varient, conditionsValue, 
				benefitType, paymentModeThrough, nraLetterReceived, retirementAgeValue, nraLetterReceivedDateValue, frequency, zone, 
				minimumAge, maximumAge, reinsurerValue, waitingPeriodValue, windowPeriodValue, gracePeriodValue, 
				...
				multiplesOfSalaryCountValueForBaseBenefit, freeCoverLimitValueForBaseBenefit, minimumCapValueForBaseBenefit, 
