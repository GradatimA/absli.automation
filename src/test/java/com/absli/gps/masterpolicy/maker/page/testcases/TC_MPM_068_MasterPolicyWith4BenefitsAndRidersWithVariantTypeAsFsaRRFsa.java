...
public class TC_MPM_068_MasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRFsa extends AbsliBase {
	...
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_068.xlsx", "TC_MPM_068");
		return arrobj;
	...
	public void createAMasterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRFsa(String clientName, 
			...
			String benefits4, String varientType4, String sumAssuredValue4, String freeCoverLimitValue4) throws Throwable
	{
		...
		masterPolicyMakerPage.masterPolicyWith4BenefitsAndRidersWithVariantTypeAsFsaRRFsa(clientName, agreementNumberValue, 
				...
				benefits4, varientType4, sumAssuredValue4, freeCoverLimitValue4);
	}
