...
public class TC_MPM_131_VerifyTheErrorPopUpMessagesForFutureServiceGratuityAmount extends AbsliBase {
	...
	@DataProvider(name="TestDataFromTC_MPM_131")
	public Object[][] getTestDataFromTestDataFromTC_MPM_131()
	{
		Object arrobj[][]=TestUtill.getDataFromExcel("C:\\Users\\Gokulnath\\git\\com.absli.auto\\com.absli.auto\\src\\main\\java\\com\\absli\\testdata\\gps\\masterpolicymaker\\Test Data For TC_MPM_131.xlsx", "TC_MPM_131");
		return arrobj;
	}
	
	@Test(priority = 130, dataProvider = "TestDataFromTC_MPM_131",dataProviderClass = TC_MPM_131_VerifyTheErrorPopUpMessagesForFutureServiceGratuityAmount.class)
	public void verifyErrorPopUpMessagesForFutureServiceGratuityAmount (String clientName, String agreementNumberValue, 
	...
	
	{
		...
		masterPolicyMakerPage.verifyTheErrorMessagesForFutureServiceGratuityAmount(clientName, agreementNumberValue, 
				...
				varientType, retirementAgeValueInVariantType, maxSumAssuredValue, freeCoverLimitValue, minimumCapValue, 
				maximumCapValue);
	}
